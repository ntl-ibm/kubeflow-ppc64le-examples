...
"""
This module defines a method to download a model from S3 storage.

It has been adapted from the KServe open source: 
https://github.com/kserve/kserve/tree/master/python/kserve/kserve/storage
